...
asset_val_per_point = zeros(length(lon_lat),1);
for p_i = 1:length(asset_val_per_point)
...
[cbar,asset_handle]= plotclr(lon_lat(:,1), lon_lat(:,2), asset_val_per_point, 's',markersize, 1,min_value,max_value,cmap,0,0);
hold on
axis equal
xlabel('Longitude')
ylabel('Latitude')
