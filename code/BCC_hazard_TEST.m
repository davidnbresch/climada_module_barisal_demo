function hazard=BCC_hazard_TEST(force_recalc)
% climada
% NAME:
...
% PARAMETERS
%
use_cbfreeze=1; % default =1 after MATLAB version 8.1.0.604 (R2013a)
%
...
TEST_country_name = 'Bangladesh_BCC'; tc_track_file='tracks.nio.txt';
%
TEST_location.name='  Barisal BCC'; % first two spaces for nicer labeling
